...
template <class Type>
TNode<Type> * Tree<Type>::search(int key, TNode<Type> * leaf)
{
	if (leaf != NULL)
	{
		if (key == leaf->key_value)
...
template<class Type>
void LinkedList<Type>::ThemNode(Type new_node)
{
	/*LNode<Type> * node = new LNode<Type>();
	node->data = new_node;
...
template<class Type>
void LinkedList<Type>::ThemNode(LNode<Type> * pHead, LNode<Type> * new_node)
{
	if (pHead == NULL)
	{
		new_node = pHead;
